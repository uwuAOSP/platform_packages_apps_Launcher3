...
public class FirstPageCompactStatusView extends FrameLayout {
    ...
    private void updateStatusInfo(@Nullable ApiWrapper.WeatherInfo weatherInfo) {
        mWeatherPendingIntent = weatherInfo == null ? null : weatherInfo.getAction();
    ...
    private void openWeather() {
        if (mWeatherPendingIntent != null) {
            Launcher.getLauncher(getContext()).sendPendingIntentWithAnimation(
                    mWeatherContainer, mWeatherPendingIntent, null);
            return;
        }
